...
[foo] > f
  foo 7 42
\end{ffsave}
\twoffinputs{0.5}{pointer-fn.c}{pointer-fn.eo}
...
malloc.empty > [] > f
  seq * > [m]
    ...
    number
      m.read (8.minus 8) 8
\end{ffsave}
\twoffinputs{0.5}{pointer-stack.c}{pointer-stack.eo}
...
if. > [x] > f
  ...
  T "bar"
\end{ffsave}
\twoffinputs{0.6}{multiple-catch.java}{multiple-catch.eo}
\begin{ffcode}
\end{ffcode}
...
max 7 42 > x
\end{ffsave}
\twoffinputs{0.6}{templates.cpp}{templates.eo}
\begin{ffcode}
\end{ffcode}
