...
\begin{ffsave}[pointer-book.c]
#include "string.h"
struct book {
  char title[100];
  unsigned int price;
};
unsigned int f(struct book* p) {
  struct book b = *(p + 7);
  strcpy(b.title, "Object Thinking");
  return b.price;
}
\end{ffsave}
\begin{ffsave}[pointer-book.eo]
[mem offset] > book
  book > [i] > plus
    mem
...
[p] > f
  (book p).plus 7 > b
  seq * > @
    b.set-title "Object Thinking"
    b.price
\end{ffsave}
\twoffinputs{0.4}{pointer-book.c}{pointer-book.eo}
